    ...
    if query.data == "removebg":
                ...
                [
                    [
                        InlineKeyboardButton(
                            text="White BG", callback_data="rmbgwhite"
                        ),
                        InlineKeyboardButton(
        ...
        keyboard = InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "Source 💻", url="https://github.com/DevelopedBots/Imagee-Bot"
                    )
                ],
            ]
        )
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🛠 Help ⚒️", callback_data="help_data"),
                    InlineKeyboardButton("👾 Start 👾", callback_data="start_data"),
                ],
                [
                    InlineKeyboardButton(
                        "Support 📢", url="t.me/DevelopedBotz"
                    )
                ],
            ]
        )
